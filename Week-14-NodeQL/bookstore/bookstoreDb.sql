...
CREATE TABLE IF NOT EXISTS `author` (
 `aut_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `book_mast` (
 `book_id` varchar(15) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 ...
 `cate_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `aut_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `pub_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `despatch` (
 `desp_no` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `desp_data` date NOT NULL DEFAULT '0000-00-00',
 `client_city` varchar(15) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `client_country` varchar(15) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `book_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `aut_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `order` (
 `ord_no` varchar(15) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `ord_date` date NOT NULL DEFAULT '0000-00-00',
 `book_id` varchar(15) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `book_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `cate_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `pub_lang` varchar(15) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `purchase` (
 `invoice_no` varchar(12) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `invoice_dt` date NOT NULL DEFAULT '0000-00-00',
 `ord_no` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
 `ord_date` date NOT NULL DEFAULT '0000-00-00',
 `receive_dt` date NOT NULL DEFAULT '0000-00-00',
 `book_id` varchar(8) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `book_name` varchar(50) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
 `pub_lang` varchar(8) COLLATE utf8mb4_general_ci DEFAULT NULL,
 `cate_id` varchar(8) COLLATE utf8mb4_general_ci DEFAULT NULL,
